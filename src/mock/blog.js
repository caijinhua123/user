      ...
      [`rows|${query.limit || 10}`]: [
        {
          ...
          category: {
            'id|1-10':1,
            // "id": query['/api/blog?categoryid']==-1?Mock.Random.natural(1,10):query['/api/blog?categoryid'],
            name: `分类@id`,
          },
          "scanNumber|0-3000": 0,
...
// Mock.mock("/data/asset", "get", {//人员热力
//   code: 0,
//   msg: "",
//   "data|10-20": [
//     {
//       coord:[() => Mock.Random.float(106.532063, 106.534063),() => Mock.Random.float(29.350652, 29.352652)],
//       "elevation|0-100": 0,
//     },
//   ],
// });
